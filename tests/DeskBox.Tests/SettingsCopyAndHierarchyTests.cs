...
public sealed class SettingsCopyAndHierarchyTests
{
    ...
    public void ConfirmedChineseCopy_UsesPreciseTerms()
    {
        ...
        IReadOnlyDictionary<string, string> expected = new Dictionary<string, string>
        {
            ...
            ["Settings.CollapseBehavior.Title"] = "默认展开方式",
            ...
            ["Settings.Capsule.Overrides.Behavior.Title"] = "展开方式与方向",
            ["Settings.Capsule.Overrides.Item.Direction"] = "展开方向：{0}",
            ...
            ["Settings.FileStacks.OpenMode.Title"] = "叠放方式",
            ["Settings.FileStacks.OpenMode.Inline"] = "格子内叠放",
            ["Settings.FileStacks.OpenMode.Popover"] = "弹出式叠放",
            ["Widget.Stack.UseDefaultOpenMode"] = "使用默认叠放方式",
